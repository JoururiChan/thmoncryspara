...
AnimObjSpiritVoiceGFX::      INCBIN "gfx/battle_anims/bugbuzz.2bpp.lz"
...
AnimObjChargeOutGFX::        INCBIN "gfx/battle_anims/uturn.2bpp.lz"
...
TohodexDLuizeLZ:: INCBIN "gfx/tohodex/wakasagi.2bpp.lz"
...
DexTilemap_Hina::       INCBIN "gfx/tohodex/hina.bin.lz"
