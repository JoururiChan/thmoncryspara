...
.ornaments:
	...
	db DECO_CYOUMU_DOLL ; 26
	db DECO_CREISEN_DOLL ; 27
	db DECO_CSANAE_DOLL ; 28
	db DECO_KURUMI_DOLL ; 29
	db DECO_CMOKOU_DOLL ; 2a
	db DECO_TEIRIN_DOLL ; 2b
	db DECO_LILYBLACK_DOLL ; 2c
	db DECO_EKOTOHIME_DOLL ; 2d
	db DECO_ESHINKI_DOLL ; 2e
	db DECO_YAMAME_DOLL ; 2f
	db DECO_LYRICA_DOLL ; 30
	db DECO_CDAICHAN_DOLL ; 31
	db DECO_ELLY_DOLL ; 32
	db DECO_CNUE_DOLL ; 33
	db DECO_CSARA_DOLL ; 34
	db DECO_NITORI_DOLL ; 35
	db DECO_AYA_DOLL ; 36
	db DECO_AIKU_DOLL ; 37
	db DECO_CHIYURI_DOLL ; 38
	db DECO_EMEIRA_DOLL ; 39
	db DECO_EORANGE_DOLL ; 3a
	db DECO_TLYRICA_DOLL ; 3b
...
.big_dolls:
	db DECO_BIG_CRAN_DOLL ; 1a
	db DECO_BIG_CRUMIA_DOLL ; 1b
	db DECO_BIG_CLYRICA_DOLL ; 1c
	db -1
