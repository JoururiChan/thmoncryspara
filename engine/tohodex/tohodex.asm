...
Tohodex_LoadTilemapWithTohopic:
	ld a, BANK(wDexTilemap)
	call StackCallInWRAMBankA
.Function:
	ld de, wDexTilemap
...
.base_data_done
	...
	pop hl
	jr z, .body_done
	ld hl, TohomonBodyData + BODY_COLOR
...
Tohodex_LoadUndiscoveredTohopic:
; Always returns z.
	ldh a, [rSVBK]
	push af
...
.inner_copy_loop
	...
	call Tohodex_GetCursorSpecies
	call GetSpeciesAndFormIndex
	ld hl, TohomonBodyData + 3 ; skip height and weight
rept 4
	add hl, bc
endr
	ld a, BANK(TohomonBodyData)
...
INCLUDE "data/tohomon/dex_order_alpha.asm"
INCLUDE "data/tohomon/dex_order_new.asm"
