...
OaksPkmnTalk1:
	...
	ld a, OAKS_TOHOMON_TALK_2
	jr NextRadioLine

OaksPkmnTalk2:
	ld hl, OPT_IntroText2
	ld a, OAKS_TOHOMON_TALK_3
	jr NextRadioLine

OaksPkmnTalk3:
	ld hl, OPT_IntroText3
	ld a, OAKS_TOHOMON_TALK_4
	jr NextRadioLine

OaksPkmnTalk4:
; Choose a random route, and a random Tohomon from that route.
	call Random
	and $1f
...
.loop2
	...
	rst AddNTimes
.loop3
	; Choose one of the middle three Tohomon.
	call Random
	...
	rst CopyBytes
	; Now that we've chosen our wild Tohomon,
	...
	ld hl, OPT_OakText1
	call CopyRadioTextToRAM
	ld a, OAKS_TOHOMON_TALK_5
	jmp PrintRadioLine

.overflow
	pop bc
	ld a, OAKS_TOHOMON_TALK
	jmp PrintRadioLine
...
OaksPkmnTalk5:
	ld hl, OPT_OakText2
	ld a, OAKS_TOHOMON_TALK_6
	jmp NextRadioLine

OaksPkmnTalk6:
	ld hl, OPT_OakText3
	ld a, OAKS_TOHOMON_TALK_7
	jmp NextRadioLine
...
OaksPkmnTalk10:
	farcall RadioMusicRestartTohomonChannel
	ld hl, EmptyString
	call PrintText
	call ApplyTilemapInVBlank
	ld hl, OPT_TohomonChannelText
	call PrintText
	ld a, OAKS_TOHOMON_TALK_11
	ld [wCurRadioLine], a
	ld a, 100
	ld [wRadioTextDelay], a
	ret

OPT_TohomonChannelText:
	; #MON
	text_far _OPT_TohomonChannelText
	text_end
...
OaksPkmnTalk11:
	...
	ret nz
	hlcoord 9, 14
	ld de, .tohomon_string
	ld a, OAKS_TOHOMON_TALK_12
	jr PlaceRadioString
...
OaksPkmnTalk12:
	...
	ret nz
	hlcoord 1, 16
	ld de, .tohomon_channel_string
	ld a, OAKS_TOHOMON_TALK_13
	jr PlaceRadioString

.tohomon_channel_string
	db "#mon Channel@"
...
BenMonMusic1:
	call StartTohomonMusicChannel
	ld hl, BenIntroText1
	ld a, TOHOMON_MUSIC_2
	jmp NextRadioLine

BenMonMusic2:
	ld hl, BenIntroText2
	ld a, TOHOMON_MUSIC_3
	jmp NextRadioLine

BenMonMusic3:
	ld hl, BenIntroText3
	ld a, TOHOMON_MUSIC_4
	jmp NextRadioLine
...
BenFernMusic6:
	...
	ld hl, BenFernText3B
.SunTueThurSun:
	ld a, TOHOMON_MUSIC_7
	jmp NextRadioLine

StartTohomonMusicChannel:
	ld hl, EmptyString
	call PrintText
	call GetWeekday
	and 1
	ld e, MUSIC_TOHOMON_MARCH
	jr z, .SunTueThurSun
	ld e, MUSIC_TOHOMON_LULLABY
.SunTueThurSun:
