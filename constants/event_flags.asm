...
; Johto Gym Leader TM gifts
	const EVENT_GOT_TM26_AERIAL_ACE
	const EVENT_GOT_TM49_ENERGY_LIGHT
	const EVENT_GOT_TM45_LUSTER_HEART
	const EVENT_GOT_TM30_SHADOW_BALL
	const EVENT_GOT_TM01_DYNAMICPUNCH
	const EVENT_GOT_TM23_BRAVER
	const EVENT_GOT_TM67_AVALANCHE
	const EVENT_GOT_TM59_ECHO_RAVE
...
; Johto story events
	const EVENT_GOT_A_TOHOMON_FROM_ELM
	const EVENT_GOT_CALICE_FROM_ELM
	const EVENT_GOT_CREISEN_FROM_ELM
	const EVENT_GOT_CSANAE_FROM_ELM
	const EVENT_GOT_MYSTERY_EGG_FROM_MR_TOHOMON
	const EVENT_GOT_TOHODEX_FROM_OAK
	...
	const EVENT_FOUGHT_CMEDICINE
	const EVENT_CLEARED_WAKASAGI_WELL
	const EVENT_REFUSED_TO_TAKE_EGG_FROM_ELMS_AIDE
	const EVENT_GOT_CFLANDRE_EGG_FROM_ELMS_AIDE
	const EVENT_MADE_CNUE_APPEAR_IN_RUINS
	...
	const EVENT_LAKE_OF_RAGE_EXPLAINED_WEIRD_LILYBLACK
	const EVENT_LAKE_OF_RAGE_ASKED_FOR_LILYBLACK
	...
	const EVENT_LEARNED_TO_CATCH_TOHOMON
	const EVENT_NEVER_LEARNED_TO_CATCH_TOHOMON
	const EVENT_ELM_CALLED_ABOUT_STOLEN_TOHOMON
	...
	const EVENT_GOT_TLYRICA
	const EVENT_GOT_KENYA
	const EVENT_GAVE_KENYA
	const EVENT_GOT_HP_UP_FROM_RANDY
	const EVENT_CFLANDRE_HATCHED
	const EVENT_SHOWED_CFLANDRE_TO_ELM
	const EVENT_GOT_ABILITYPATCH_FROM_ELM
	...
	const EVENT_GOT_KINGS_ROCK_IN_WAKASAGI_WELL
	const EVENT_GOT_TM47_STEEL_WING
	const EVENT_FIRST_TIME_BANKING_WITH_MOM
	const EVENT_TOLD_ELM_ABOUT_CFLANDRE_OVER_THE_PHONE
	const EVENT_GOT_CLEAR_BELL
	const EVENT_GOT_OLD_AMBER
	const EVENT_GOT_TM54_BLADE_FLASH
...
; Johto hidden items
	...
	const EVENT_WAKASAGI_WELL_ENTRANCE_HIDDEN_SUPER_POTION
	...
	const EVENT_GOLDENROD_TOHOCOM_CENTER_1F_HIDDEN_RARE_CANDY
	...
	const EVENT_VIOLET_CITY_HIDDEN_TOHO_BALL
...
; Crystal-exclusive events in Johto
	...
	const EVENT_GOT_TM69_CHARGE_OUT_FROM_VALERIE
...
; Kanto story events
	...
	const EVENT_GOT_TM65_SHADOW_HIT_FROM_AGATHA
	...
	const EVENT_GOT_TM29_MANA_BURST
	const EVENT_GOT_TM61_WILL_O_WISP
	const EVENT_GOT_TM71_STONE_BREAK
	...
	const EVENT_SHOWED_SAFFRON_KID_HRIN
	...
	const EVENT_GOT_TOXIN_SHOT_LILYBLACK
	const EVENT_GOT_LUCKY_EGG_FROM_LUCKY_ISLAND
	const EVENT_LISTENED_TO_AQUA_CUT_INTRO
	...
	const EVENT_LISTENED_TO_BLAZE_STAR_INTRO
...
; Orange story events
	...
	const EVENT_HEALED_RIKA
	const EVENT_GOT_MOON_STONE_FROM_IVY
	const EVENT_LISTENED_TO_BODY_SLAM_INTRO

; Kanto hidden items
	const EVENT_CCHIYURIS_CAVE_HIDDEN_MAX_REVIVE
	const EVENT_CCHIYURIS_CAVE_HIDDEN_MAX_REPEL
	...
	const EVENT_TOHOMON_MANSION_1F_HIDDEN_FULL_RESTORE
	const EVENT_TOHOMON_MANSION_1F_HIDDEN_PP_UP
	const EVENT_TOHOMON_MANSION_B1F_HIDDEN_MAX_ELIXIR
	const EVENT_TOHOMON_MANSION_B1F_HIDDEN_RARE_CANDY
	const EVENT_TOHOMON_MANSION_B1F_HIDDEN_BERSERK_GENE
...
; Ruins of Alph puzzles
	const EVENT_SOLVED_CICHIRIN_PUZZLE
	const EVENT_SOLVED_CYUYUKO_PUZZLE
	const EVENT_SOLVED_LUNASA_PUZZLE
	const EVENT_SOLVED_AYUYUKO_PUZZLE
...
; Decorations
	...
	const EVENT_DECO_EKIKURI_DOLL
	const EVENT_DECO_CSARIEL_DOLL
	const EVENT_DECO_SURFING_EKIKURI_DOLL
	const EVENT_DECO_CMEIRA_DOLL
	const EVENT_DECO_ELLEN_DOLL
	const EVENT_DECO_CREIMU_DOLL
	const EVENT_DECO_CMARISA_DOLL
	const EVENT_DECO_CSAKUYA_DOLL
	const EVENT_DECO_CYOUMU_DOLL
	const EVENT_DECO_CREISEN_DOLL
	const EVENT_DECO_CSANAE_DOLL
	const EVENT_DECO_KURUMI_DOLL
	const EVENT_DECO_CMOKOU_DOLL
	const EVENT_DECO_TEIRIN_DOLL
	const EVENT_DECO_LILYBLACK_DOLL
	const EVENT_DECO_EKOTOHIME_DOLL
	const EVENT_DECO_ESHINKI_DOLL
	const EVENT_DECO_YAMAME_DOLL
	const EVENT_DECO_LYRICA_DOLL
	const EVENT_DECO_CDAICHAN_DOLL
	const EVENT_DECO_ELLY_DOLL
	const EVENT_DECO_CNUE_DOLL
	const EVENT_DECO_CSARA_DOLL
	const EVENT_DECO_NITORI_DOLL
	const EVENT_DECO_AYA_DOLL
	const EVENT_DECO_AIKU_DOLL
	const EVENT_DECO_CHIYURI_DOLL
	const EVENT_DECO_EMEIRA_DOLL
	const EVENT_DECO_EORANGE_DOLL
	const EVENT_DECO_TLYRICA_DOLL
	const EVENT_PLAYERS_ROOM_POSTER
	const EVENT_DECO_GOLD_TROPHY
	const EVENT_DECO_SILVER_TROPHY
	const EVENT_DECO_BIG_CRAN_DOLL
	const EVENT_DECO_BIG_CRUMIA_DOLL
	const EVENT_DECO_BIG_CLYRICA_DOLL
...
; More Johto story events
	...
	const EVENT_LEARNED_WAKASAGITAIL
	const EVENT_LEARNED_CELIS_TAIL
	...
	const EVENT_FOUGHT_CICHIRIN
	const EVENT_FOUGHT_TKOGASA
	const EVENT_BEAT_RIVAL_IN_MT_MOON
	const EVENT_TRADED_RED_SCALE
	const EVENT_BRED_AN_EGG
	const EVENT_MET_BILLS_GRANDPA
	const EVENT_SHOWED_CGYOKU_TO_BILLS_GRANDPA
	const EVENT_SHOWED_CWRIGGLE_TO_BILLS_GRANDPA
	const EVENT_SHOWED_CCHIYURI_TO_BILLS_GRANDPA
	const EVENT_SHOWED_CSARA_TO_BILLS_GRANDPA
	const EVENT_SHOWED_CRIKA_TO_BILLS_GRANDPA
	const EVENT_SHOWED_CREISEN_TO_BILLS_GRANDPA
	const EVENT_SHOWED_CDAICHAN_TO_BILLS_GRANDPA
	const EVENT_SHOWED_CRUMIA_TO_BILLS_GRANDPA
	const EVENT_SHOWED_CKIKURI_TO_BILLS_GRANDPA
...
; More Crystal-exclusive events in Johto
	const EVENT_WALL_OPENED_IN_CICHIRIN_CHAMBER
	const EVENT_WALL_OPENED_IN_CYUYUKO_CHAMBER
	const EVENT_WALL_OPENED_IN_LUNASA_CHAMBER
	const EVENT_WALL_OPENED_IN_AYUYUKO_CHAMBER
	const EVENT_DOOR_OPENED_IN_RUINS_OF_ALPH
	const EVENT_BATTLE_TOWER_OPEN
	const EVENT_BATTLE_TOWER_CLOSED
	const EVENT_WELCOMING_TO_TOHOCOM_CENTER
	const EVENT_WELCOMED_TO_TOHOCOM_CENTER
	...
	const EVENT_GOT_GS_BALL_FROM_TOHOCOM_CENTER
	...
	const EVENT_GOT_CREIMU_FROM_IVY
	const EVENT_GOT_CMARISA_FROM_IVY
	const EVENT_GOT_CSAKUYA_FROM_IVY
	const EVENT_GOT_A_TOHOMON_FROM_IVY
	const EVENT_GOT_A_TOHOMON_FROM_OAK
	const EVENT_GOT_A_TOHOMON_FROM_YELLOW
...
; TohofanM
	const EVENT_BEAT_TOHOFANM_DEREK
	const EVENT_BEAT_TOHOFANM_WILLIAM
	const EVENT_BEAT_TOHOFANM_ROBERT
	const EVENT_BEAT_TOHOFANM_JOSHUA
	const EVENT_BEAT_TOHOFANM_CARTER
	const EVENT_BEAT_TOHOFANM_TREVOR
	const EVENT_BEAT_TOHOFANM_BRANDON
	const EVENT_BEAT_TOHOFANM_JEREMY
	const EVENT_BEAT_TOHOFANM_COLIN
	const EVENT_BEAT_TOHOFANM_ALEX
	const EVENT_BEAT_TOHOFANM_REX
	const EVENT_BEAT_TOHOFANM_ALLAN
; TohofanF
	const EVENT_BEAT_TOHOFANF_BEVERLY
	const EVENT_BEAT_TOHOFANF_RUTH
	const EVENT_BEAT_TOHOFANF_GEORGIA
	const EVENT_BEAT_TOHOFANF_JAIME
	const EVENT_BEAT_TOHOFANF_BOONE
	const EVENT_BEAT_TOHOFANF_ELEANOR
; OfficerM
...
; Tohomaniac
	const EVENT_BEAT_TOHOMANIAC_BRENT
	const EVENT_BEAT_TOHOMANIAC_LARRY
	const EVENT_BEAT_TOHOMANIAC_ANDREW
	const EVENT_BEAT_TOHOMANIAC_CALVIN
	const EVENT_BEAT_TOHOMANIAC_SHANE
	const EVENT_BEAT_TOHOMANIAC_BEN
	const EVENT_BEAT_TOHOMANIAC_RON
	const EVENT_BEAT_TOHOMANIAC_ETHAN
	const EVENT_BEAT_TOHOMANIAC_ISSAC
	const EVENT_BEAT_TOHOMANIAC_DONALD
	const EVENT_BEAT_TOHOMANIAC_ZACH
	const EVENT_BEAT_TOHOMANIAC_MILLER
	const EVENT_BEAT_TOHOMANIAC_AIDAN
	const_skip ; unused
; Cosplayer
...
; Schoolgirl
	...
	const EVENT_BEAT_SCHOOLGIRL_FAITH_T
...
; Hex Maniac
	...
	const EVENT_BEAT_HEX_MANIAC_LUNA_T
...
; Bill
	const EVENT_BEAT_TOHOMANIAC_BILL
; Yellow
...
; Johto itemballs
	const EVENT_CALICE_TOHOBALL_IN_ELMS_LAB
	const EVENT_CREISEN_TOHOBALL_IN_ELMS_LAB
	const EVENT_CSANAE_TOHOBALL_IN_ELMS_LAB
	...
	const EVENT_AUTUMN_TOWER1F_PARALYZEHEAL
	const EVENT_AUTUMN_TOWER2F_X_ACCURACY
	const EVENT_AUTUMN_TOWER_3F_POTION
	const EVENT_AUTUMN_TOWER_3F_ESCAPE_ROPE
	...
	const EVENT_WAKASAGI_WELL_B1F_SUPER_POTION
	const EVENT_WAKASAGI_WELL_B2F_DAMP_ROCK
	...
	const EVENT_OLIVINE_LIGHTHOUSE_5F_TM_SPORE
	...
	const EVENT_UNDERGROUND_WAREHOUSE_TM_CROSS_EYE
	...
	const EVENT_ROUTE_35_TM_HONE_TOOLS
...
; Johto people
	...
	const EVENT_RIVAL_AUTUMN_TOWER
	...
	const EVENT_MR_TOHOMONS_HOUSE_OAK
	const EVENT_DARK_CAVE_FALKNER
	const EVENT_DARK_CAVE_CRIKAKO
	const EVENT_DARK_CAVE_SEIJA
	...
	const EVENT_MAHOGANY_MART_LANCE_AND_CSUIKA
	...
	const EVENT_TEAM_ROCKET_BASE_B2F_CSUIKA
	const EVENT_TEAM_ROCKET_BASE_B2F_CCIRNO_1
	const EVENT_TEAM_ROCKET_BASE_B2F_CCIRNO_2
	const EVENT_TEAM_ROCKET_BASE_B2F_CCIRNO_3
	...
	const EVENT_ILEX_FOREST_ICHIRIN
	...
	const EVENT_CHARCOAL_KILN_CMAI
	const EVENT_CHARCOAL_KILN_APPRENTICE
	const EVENT_CHARCOAL_KILN_BOSS
	const EVENT_ROUTE_36_CMEDICINE
	const EVENT_AZALEA_TOWN_WAKASAGIS
	const EVENT_AZALEA_TOWN_WAKASAGITAIL_ROCKET
	const EVENT_WAKASAGI_WELL_WAKASAGIS
	const EVENT_WAKASAGI_WELL_ROCKETS
	const EVENT_KURTS_HOUSE_WAKASAGI
	const EVENT_GUIDE_GENT_IN_HIS_HOUSE
	const EVENT_GUIDE_GENT_VISIBLE_IN_CHERRYGROVE
	const EVENT_ELMS_AIDE_IN_VIOLET_TOHOMON_CENTER
	...
	const EVENT_ECRUTEAK_TOHO_CENTER_BILL
	...
	const EVENT_TIN_TOWER_ROOF_CICHIRIN
	const EVENT_WHIRL_ISLAND_TKOGASA_CHAMBER_TKOGASA
	const EVENT_KURTS_HOUSE_KURT_1
	const EVENT_KURTS_HOUSE_KURT_2
	const EVENT_WAKASAGI_WELL_KURT
	...
	const EVENT_RUINS_OF_ALPH_CYUYUKO_CHAMBER_RECEPTIONIST
	const EVENT_LISTENED_TO_OAK_INTRO
	const EVENT_OPENED_MT_SILVER
	const EVENT_LISTENED_TO_YELLOW_INTRO
	const EVENT_FOUGHT_CRAN
	const EVENT_LAKE_OF_RAGE_RED_SLILYBLACK
	...
	const EVENT_MAHOGANY_TOWN_TOHOFAN_M_BLOCKS_EAST
	const EVENT_MAHOGANY_TOWN_TOHOFAN_M_BLOCKS_GYM
	...
	const EVENT_UNION_CAVE_B2F_CLYRICA
	...
	const EVENT_FLORIA_AT_CMEDICINE
	...
	const EVENT_YELLOW_FOREST_PARSEE
	const EVENT_MYSTRI_CNUE_W
	const EVENT_MYSTRI_CNUE_A
	const EVENT_MYSTRI_CNUE_R
	const EVENT_MYSTRI_CNUE_P
	...
	const EVENT_GIOVANNIS_CAVE_ICHIRIN
...
; Kanto itemballs
	...
	const EVENT_CELADON_HOTEL_ROOM_1_TOHO_DOLL
	const EVENT_CCHIYURIS_CAVE_RARE_BONE
	...
	const EVENT_ROUTE_9_TM_STAR_CANNON
	...
	const EVENT_CINNABAR_ISLAND_LILYWHITEIZER
	...
	const EVENT_TOHOMON_MANSION_1F_MOON_STONE
	const EVENT_TOHOMON_MANSION_1F_ESCAPE_ROPE
	const EVENT_TOHOMON_MANSION_1F_PROTEIN
	const EVENT_TOHOMON_MANSION_1F_IRON
	const EVENT_TOHOMON_MANSION_B1F_CARBOS
	const EVENT_TOHOMON_MANSION_B1F_CALCIUM
	const EVENT_TOHOMON_MANSION_B1F_HP_UP
	const EVENT_TOHOMON_MANSION_B1F_OLD_SEA_MAP
...
; Kanto people
	...
	const EVENT_VERMILION_CITY_CRAN
	const EVENT_ROUTE_8_CRAN
	const EVENT_ROUTE_5_6_TOHOFAN_M_BLOCKS_UNDERGROUND_PATH
	...
	const EVENT_ROUTE_8_KANTO_TOHOMON_FEDERATION
	...
	const EVENT_MT_MOON_SQUARE_CMEIRA
	const EVENT_MT_MOON_RIVAL
	const EVENT_INDIGO_PLATEAU_TOHOCENTER_RIVAL
	const EVENT_INDIGO_PLATEAU_TOHOCENTER_LYRA
	const EVENT_INDIGO_PLATEAU_TOHOCENTER_YELLOW
	const EVENT_TELEPORT_GUY
	const EVENT_ROCK_TUNNEL_2F_CCIRNO
	const EVENT_SEAFOAM_ISLANDS_RAN
	const EVENT_TRAN_GONE
	const EVENT_ROUTE_10_TRAN
	const EVENT_CINNABAR_VOLCANO_CYUKARI
	const EVENT_CERULEAN_CAVE_SUIKA
	const EVENT_FARAWAY_JUNGLE_TSUIKA
	const EVENT_LAWRENCE_VERMILION_CITY
	const EVENT_LAWRENCE_ROUTE_10
	const EVENT_LAWRENCES_TRAN_ROUTE_10
	...
	const EVENT_CINNABAR_LAB_SUIKA
...
; Orange people
	...
	const EVENT_SHAMOUTI_TOHO_CENTER_IVY
...
; New to Crystal
	...
	const EVENT_PICKED_UP_SUN_STONE_FROM_CICHIRIN_ITEM_ROOM
	const EVENT_PICKED_UP_MOON_STONE_FROM_CICHIRIN_ITEM_ROOM
	const EVENT_PICKED_UP_LIFE_ORB_FROM_CICHIRIN_ITEM_ROOM
	const EVENT_PICKED_UP_CHARCOAL_FROM_CICHIRIN_ITEM_ROOM
	const EVENT_PICKED_UP_SITRUS_BERRY_FROM_CYUYUKO_ITEM_ROOM
	const EVENT_PICKED_UP_LUM_BERRY_FROM_CYUYUKO_ITEM_ROOM
	const EVENT_PICKED_UP_HEAL_POWDER_FROM_CYUYUKO_ITEM_ROOM
	const EVENT_PICKED_UP_ENERGYPOWDER_FROM_CYUYUKO_ITEM_ROOM
	const EVENT_PICKED_UP_PEARL_STRING_FROM_LUNASA_ITEM_ROOM
	const EVENT_PICKED_UP_BIG_PEARL_FROM_LUNASA_ITEM_ROOM
	const EVENT_PICKED_UP_STARDUST_FROM_LUNASA_ITEM_ROOM
	const EVENT_PICKED_UP_STAR_PIECE_FROM_LUNASA_ITEM_ROOM
	const EVENT_PICKED_UP_RARE_BONE_FROM_AYUYUKO_ITEM_ROOM
	const EVENT_PICKED_UP_ENERGY_ROOT_FROM_AYUYUKO_ITEM_ROOM
	const EVENT_PICKED_UP_REVIVAL_HERB_FROM_AYUYUKO_ITEM_ROOM
	const EVENT_PICKED_UP_SOOTHE_BELL_FROM_AYUYUKO_ITEM_ROOM
	...
	const EVENT_SAW_NAZRIN_AT_CIANWOOD_CITY
	const EVENT_SAW_NAZRIN_ON_ROUTE_42
	const EVENT_SAW_NAZRIN_ON_ROUTE_36
	const EVENT_ECRUTEAK_HOUSE_WANDERING_SAGE
	const EVENT_TIN_TOWER_1F_NAZRIN
	const EVENT_TIN_TOWER_1F_CNAZRIN
	const EVENT_TIN_TOWER_1F_SKOISHI
...
; TODO: rearrange
	...
	const EVENT_GOT_ROOM_SERVICE_IN_CELADON_HOTEL
