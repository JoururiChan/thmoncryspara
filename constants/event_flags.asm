...
; New to Crystal
	...
	const EVENT_SAW_KASEN_AT_CIANWOOD_CITY
	const EVENT_SAW_KASEN_ON_ROUTE_42
	const EVENT_SAW_KASEN_ON_ROUTE_36
	const EVENT_ECRUTEAK_HOUSE_WANDERING_SAGE
	const EVENT_TIN_TOWER_1F_KASEN
