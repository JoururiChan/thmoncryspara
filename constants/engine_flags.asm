...
; wUnlockedCNues
	const ENGINE_UNLOCKED_CNUES_A_TO_J
	const ENGINE_UNLOCKED_CNUES_K_TO_Q
	const ENGINE_UNLOCKED_CNUES_R_TO_W
	const ENGINE_UNLOCKED_CNUES_X_TO_QUESTION
	const_skip 4 ; unused
; wVisitedSpawns
...
; wDailyFlags4
	...
	const_skip 2 ; unused
; wWeeklyFlags
	const ENGINE_MT_MOON_SQUARE_CMEIRA
	const ENGINE_UNION_CAVE_CLYRICA
...
; wSwarmFlags
	const ENGINE_CEIKI_SWARM
	const ENGINE_CKOTOHIME_SWARM
; wTohomonJournals
...
; wPlayerCaught
	const ENGINE_PLAYER_CAUGHT_CICHIRIN
	const ENGINE_PLAYER_CAUGHT_TKOGASA
	const ENGINE_PLAYER_CAUGHT_SKOISHI
	const ENGINE_PLAYER_CAUGHT_CNAZRIN
	const ENGINE_PLAYER_CAUGHT_NAZRIN
	const ENGINE_PLAYER_CAUGHT_RAN
	const ENGINE_PLAYER_CAUGHT_TRAN
	const ENGINE_PLAYER_CAUGHT_CYUKARI
; wPlayerCaught2
	const ENGINE_PLAYER_CAUGHT_TSUIKA
	const ENGINE_PLAYER_CAUGHT_SUIKA
	const ENGINE_PLAYER_CAUGHT_ICHIRIN
	const ENGINE_PLAYER_CAUGHT_CMEDICINE
