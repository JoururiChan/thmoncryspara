; base data struct members (see data/tohomon/base_stats/*.asm)
rsreset
...
; body data struct members (see data/tohomon/body_data.asm)
rsreset
DEF BODY_HEIGHT rb
DEF BODY_COST rw
DEF BODY_COLOR  rb
...
; shapes (see data/tohomon/body_data.asm)
	const_def
	const SHAPE_HEAD         ; 0
...
; body colors (see data/tohomon/body_data.asm)
	const_def
...
; gender values
DEF YANG   EQU %00000000
DEF YIN EQU %10000000
...
; maximum number of party tohomon
...
; evolution types (used in data/tohomon/evos_attacks.asm)
	const_def
