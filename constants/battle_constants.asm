...
; battle types (wBattleType values)
	...
	const BATTLETYPE_RED_SLILYBLACK
...
; BattleVarPairs indexes (see home/battle_vars.asm)
	...
	const BATTLE_VARS_LINGER_POWER_BERRY
...
; BattleVarLocations indexes (see home/battle_vars.asm)
	...
	const PLAYER_LINGER_POWER_BERRY
	const ENEMY_LINGER_POWER_BERRY
...
DEF HAZARDS_POISON_NAIL EQU %11000000
...
; wBattleResult
	...
	const_def 6
	const BATTLERESULT_CAUGHT_TOHOMON_F ; 6
	const BATTLERESULT_BOX_FULL_F       ; 7
DEF BATTLERESULT_BITMASK EQU (1 << BATTLERESULT_CAUGHT_TOHOMON_F) | (1 << BATTLERESULT_BOX_FULL_F)
...
if DEF(FAITHFUL)
DEF DVS_HP_DREAM EQUS "$00, $ee, $ee"
DEF DVS_HP_FLYING   EQUS "$ee, $ef, $ee"
DEF DVS_HP_MIASMA   EQUS "$00, $ef, $ee"
DEF DVS_HP_EARTH   EQUS "$00, $00, $ee"
DEF DVS_HP_BEAST     EQUS "$00, $ee, $fe"
...
DEF DVS_HP_NATURE    EQUS "$fe, $00, $ef"
DEF DVS_HP_WIND EQUS "$00, $00, $ef"
DEF DVS_HP_REASON  EQUS "$fe, $fe, $00"
DEF DVS_HP_ICE      EQUS "$fe, $ef, $00"
DEF DVS_HP_FAITH   EQUS "$fe, $00, $00"
...
DEF DVS_HP_NATURE    EQUS "$00, $ef, $ef"
DEF DVS_HP_WIND EQUS "$00, $00, $ef"
DEF DVS_HP_REASON  EQUS "$00, $ee, $00"
DEF DVS_HP_ICE      EQUS "$00, $fe, $00"
DEF DVS_HP_FAITH   EQUS "$00, $ef, $00"
