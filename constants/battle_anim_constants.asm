...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const ANIM_OBJ_STONE_BREAK
	const ANIM_OBJ_STONE_BREAK_STILL
	...
	const ANIM_OBJ_TOHO_BALL_BG
	const ANIM_OBJ_FLARE_OUT
	const ANIM_OBJ_RADIAL_FLAME
	const ANIM_OBJ_AQUA_CHARGE
	...
	const ANIM_OBJ_SPIRIT_VOICE
	const ANIM_OBJ_MID_GLOW_SHRINKING
	const ANIM_OBJ_ECHO_RAVE
	...
	const ANIM_OBJ_BLAZE_STAR
	const ANIM_OBJ_BLAZE_STAR_PARTICLE
	const ANIM_OBJ_SEISMIC_TOSS_UP
	const ANIM_OBJ_SEISMIC_TOSS_DOWN
	const ANIM_OBJ_POWER_TRICK_DEBRIS
	...
	const ANIM_OBJ_STAR_CANNON_CHARGE
	const ANIM_OBJ_SLOW_GROWING_GLOW
	const ANIM_OBJ_STAR_CANNON_SPARKS_WHITE
	const ANIM_OBJ_STAR_CANNON_SPARKS_RED
	const ANIM_OBJ_STAR_CANNON
...
; DoBattleAnimFrame arguments (see engine/battle_anims/functions.asm)
	...
	const BATTLEANIMFUNC_HELLBLAZE
	...
	const BATTLEANIMFUNC_TOHOBALL
	const BATTLEANIMFUNC_TOHOBALL_BLOCKED
	...
	const BATTLEANIMFUNC_FANG_SHOT
	...
	const BATTLEANIMFUNC_LEAF_STORM
	...
	const BATTLEANIMFUNC_TOHO_BALL_BG
...
; BattleAnimFrameData indexes (see data/battle_anims/framesets.asm)
	...
	const BATTLEANIMFRAMESET_STONE_BREAK
	...
	const BATTLEANIMFRAMESET_ECHO_RAVE
	...
	const BATTLEANIMFRAMESET_CHARGE_OUT_FALL
	...
	const BATTLEANIMFRAMESET_STAR_CANNON_CHARGE_ORB
	const BATTLEANIMFRAMESET_SLOW_GROWING_GLOW
	const BATTLEANIMFRAMESET_STAR_CANNON_SPARKS
	const BATTLEANIMFRAMESET_TINY_GLOW
	const BATTLEANIMFRAMESET_PULSING_SPARKLE
	const BATTLEANIMFRAMESET_BLACK_RIPPLE_SMOKE
	...
	const BATTLEANIMFRAMESET_HONE_TOOLS_LEFT
	const BATTLEANIMFRAMESET_HONE_TOOLS_RIGHT
...
DEF FIRST_DYNAMIC_FRAMESET EQU const_value
	...
	const BATTLEANIMFRAMESET_SPIRIT_VOICE
...
; BattleAnimOAMData indexes (see data/battle_anims/oam.asm)
	...
	const BATTLEANIMOAMSET_STONE_BREAK
	const BATTLEANIMOAMSET_BRICK_BREAK
	const BATTLEANIMOAMSET_VOICE_BIND ; d1 in chatty
	const BATTLEANIMOAMSET_SPIRIT_VOICE1 ; ee in chatty
	const BATTLEANIMOAMSET_SPIRIT_VOICE2 ; ed in chatty
	const BATTLEANIMOAMSET_STEEL_FIST ; e2 in chatty
	const BATTLEANIMOAMSET_CHARGE_OUT_FALL ; ef
	...
	const BATTLEANIMOAMSET_HONE_TOOLS_1
	const BATTLEANIMOAMSET_HONE_TOOLS_2
	const BATTLEANIMOAMSET_HONE_TOOLS_3
	const BATTLEANIMOAMSET_HONE_TOOLS_4
...
; BattleBGEffects indexes (see engine/battle_anims/bg_effects.asm)
	...
	const ANIM_BG_POISON_TEARS_ARMOR
...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_PSYCHO_CUT     ; e
	const PAL_BTLCUSTOM_TOXIN_SHOT      ; f
