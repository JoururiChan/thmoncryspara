...
; SpriteAnimSeqData indexes (see data/sprite_anims/sequences.asm)
	...
	const SPRITE_ANIM_INDEX_SLOTS_ESARA
	const SPRITE_ANIM_INDEX_SLOTS_CREMILIA
...
;	const SPRITE_ANIM_INDEX_MEMORY_GAME
	const SPRITE_ANIM_INDEX_TOHOGEAR_MODE_ARROW
	const SPRITE_ANIM_INDEX_TRADE_TOHO_BALL
	...
	const SPRITE_ANIM_INDEX_INTRO_NAZRIN
	const SPRITE_ANIM_INDEX_INTRO_TTEI
	const SPRITE_ANIM_INDEX_INTRO_CSHIZUHA
	const SPRITE_ANIM_INDEX_INTRO_CNUE
	const SPRITE_ANIM_INDEX_INTRO_CNUE_F
	const SPRITE_ANIM_INDEX_INTRO_NAZRIN_AWAY
	const SPRITE_ANIM_INDEX_ICHIRIN
	...
	const SPRITE_ANIM_INDEX_DEX_CNUE_CURSOR
	const SPRITE_ANIM_INDEX_DEX_DLUIZE
...
; DoAnimFrame.Jumptable indexes (see engine/gfx/sprite_anims.asm)
	...
	const SPRITE_ANIM_SEQ_SLOTS_ESARA
	const SPRITE_ANIM_SEQ_SLOTS_CREMILIA
	const SPRITE_ANIM_SEQ_SLOTS_EGG
;	const SPRITE_ANIM_SEQ_MEMORY_GAME_CURSOR
	const SPRITE_ANIM_SEQ_TOHOGEAR_MODE_ARROW
	const SPRITE_ANIM_SEQ_TRADE_TOHO_BALL
	...
	const SPRITE_ANIM_SEQ_INTRO_NAZRIN
	const SPRITE_ANIM_SEQ_TTEI_CSHIZUHA
	const SPRITE_ANIM_SEQ_CNUE
	const SPRITE_ANIM_SEQ_CNUE_F
	const SPRITE_ANIM_SEQ_NAZRIN_AWAY
	const SPRITE_ANIM_SEQ_ICHIRIN
...
; SpriteAnimFrameData indexes (see data/sprite_anims/framesets.asm)
	...
	const SPRITE_ANIM_FRAMESET_SLOTS_ESARA
	const SPRITE_ANIM_FRAMESET_SLOTS_CREMILIA
	const SPRITE_ANIM_FRAMESET_SLOTS_CREMILIA_2
	const SPRITE_ANIM_FRAMESET_SLOTS_EGG
	const SPRITE_ANIM_FRAMESET_RED_WALK
	const SPRITE_ANIM_FRAMESET_STILL_CURSOR
	const SPRITE_ANIM_FRAMESET_TRADE_TOHO_BALL
	const SPRITE_ANIM_FRAMESET_TRADE_TOHO_BALL_0
	...
	const SPRITE_ANIM_FRAMESET_INTRO_NAZRIN
	const SPRITE_ANIM_FRAMESET_INTRO_NAZRIN_2
	const SPRITE_ANIM_FRAMESET_INTRO_TTEI
	const SPRITE_ANIM_FRAMESET_INTRO_CSHIZUHA
	const SPRITE_ANIM_FRAMESET_INTRO_CNUE_1
	const SPRITE_ANIM_FRAMESET_INTRO_CNUE_2
	const SPRITE_ANIM_FRAMESET_INTRO_CNUE_3
	const SPRITE_ANIM_FRAMESET_INTRO_CNUE_4
	const SPRITE_ANIM_FRAMESET_INTRO_CNUE_F_2
	const SPRITE_ANIM_FRAMESET_INTRO_NAZRIN_AWAY
	const SPRITE_ANIM_FRAMESET_INTRO_CNUE_F
	const SPRITE_ANIM_FRAMESET_ICHIRIN_LEFT
	const SPRITE_ANIM_FRAMESET_ICHIRIN_RIGHT
	...
	const SPRITE_ANIM_FRAMESET_DEX_CNUE_CURSOR
	const SPRITE_ANIM_FRAMESET_DEX_DLUIZE
...
; SpriteAnimOAMData indexes (see data/sprite_anims/oam.asm)
	...
	const SPRITE_ANIM_OAMSET_SLOTS_ESARA_1
	const SPRITE_ANIM_OAMSET_SLOTS_ESARA_2
	const SPRITE_ANIM_OAMSET_SLOTS_CREMILIA_1
	const SPRITE_ANIM_OAMSET_SLOTS_CREMILIA_2
	const SPRITE_ANIM_OAMSET_SLOTS_CREMILIA_3
	const SPRITE_ANIM_OAMSET_SLOTS_CREMILIA_4
	const SPRITE_ANIM_OAMSET_SLOTS_CREMILIA_5
	const SPRITE_ANIM_OAMSET_SLOTS_EGG
	const SPRITE_ANIM_OAMSET_STILL_CURSOR
	const SPRITE_ANIM_OAMSET_TRADE_TOHO_BALL_1
	const SPRITE_ANIM_OAMSET_TRADE_TOHO_BALL_2
	...
	const SPRITE_ANIM_OAMSET_INTRO_NAZRIN_1
	const SPRITE_ANIM_OAMSET_INTRO_NAZRIN_2
	const SPRITE_ANIM_OAMSET_INTRO_NAZRIN_3
	const SPRITE_ANIM_OAMSET_INTRO_NAZRIN_4
	const SPRITE_ANIM_OAMSET_INTRO_TTEI_1
	const SPRITE_ANIM_OAMSET_INTRO_TTEI_2
	const SPRITE_ANIM_OAMSET_INTRO_TTEI_3
	const SPRITE_ANIM_OAMSET_INTRO_CSHIZUHA
	const SPRITE_ANIM_OAMSET_INTRO_CNUE_1
	const SPRITE_ANIM_OAMSET_INTRO_CNUE_2
	const SPRITE_ANIM_OAMSET_INTRO_CNUE_3
	const SPRITE_ANIM_OAMSET_INTRO_CNUE_F_2_1
	const SPRITE_ANIM_OAMSET_INTRO_CNUE_F_2_2
	const SPRITE_ANIM_OAMSET_INTRO_CNUE_F_2_3
	const SPRITE_ANIM_OAMSET_INTRO_CNUE_F_2_4
	const SPRITE_ANIM_OAMSET_INTRO_CNUE_F_2_5
	const SPRITE_ANIM_OAMSET_INTRO_NAZRIN_AWAY
	const SPRITE_ANIM_OAMSET_ICHIRIN_1
	const SPRITE_ANIM_OAMSET_ICHIRIN_2
	...
	const SPRITE_ANIM_OAMSET_DEX_CNUE_CURSOR
	const SPRITE_ANIM_OAMSET_DEX_DLUIZE_1
	const SPRITE_ANIM_OAMSET_DEX_DLUIZE_2
	const SPRITE_ANIM_OAMSET_DEX_DLUIZE_3
	const SPRITE_ANIM_OAMSET_DEX_DLUIZE_4
	const SPRITE_ANIM_OAMSET_DEX_DLUIZE_5
