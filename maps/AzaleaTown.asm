AzaleaTown_MapScriptHeader:
	...
	bg_event 29,  8, BGEVENT_JUMPTEXT, WakasagiWellSignText
	...
	object_event 15, 13, SPRITE_TOHOFAN_F, SPRITEMOVEDATA_WALK_UP_DOWN, 1, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, AzaleaTownTeacherScript, -1
	...
	object_event 10, 16, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, AzaleaTownRocket2Text, EVENT_WAKASAGI_WELL_ROCKETS
	object_event  8, 17, SPRITE_MON_ICON, SPRITEMOVEDATA_TOHOMON, 0, CKOMACHI, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, PLAIN_FORM, AzaleaTownWakasagiScript, EVENT_AZALEA_TOWN_WAKASAGIS
...
WakasagiWellSignText:
	...
	para "Locals believe"
	line "that a Wakasagi's"
	cont "yawn summons rain."

	para "Records show that"
	line "a Wakasagi's yawn"
