...
; SPRITE_ANIM_INDEX_NAMING_SCREEN_CURSOR_BLUE
	db SPRITE_ANIM_FRAMESET_TEXT_ENTRY_CURSOR_BLUE, SPRITE_ANIM_SEQ_NAMING_SCREEN_CURSOR, $05
; SPRITE_ANIM_INDEX_GAMEFREAK_LOGO
	db SPRITE_ANIM_FRAMESET_GAMEFREAK_LOGO, SPRITE_ANIM_SEQ_GAMEFREAK_LOGO, $00
; SPRITE_ANIM_INDEX_SLOTS_ESARA
	db SPRITE_ANIM_FRAMESET_SLOTS_ESARA, SPRITE_ANIM_SEQ_SLOTS_ESARA, $07
; SPRITE_ANIM_INDEX_SLOTS_CREMILIA
	db SPRITE_ANIM_FRAMESET_SLOTS_CREMILIA, SPRITE_ANIM_SEQ_SLOTS_CREMILIA, $07
...
; SPRITE_ANIM_INDEX_COMPOSE_MAIL_CURSOR_BLUE
	db SPRITE_ANIM_FRAMESET_TEXT_ENTRY_CURSOR_BLUE, SPRITE_ANIM_SEQ_COMPOSE_MAIL_CURSOR, $05
...
; SPRITE_ANIM_INDEX_TOHOGEAR_MODE_ARROW
	db SPRITE_ANIM_FRAMESET_STILL_CURSOR, SPRITE_ANIM_SEQ_TOHOGEAR_MODE_ARROW, $08
; SPRITE_ANIM_INDEX_TRADE_TOHO_BALL
	db SPRITE_ANIM_FRAMESET_TRADE_TOHO_BALL, SPRITE_ANIM_SEQ_TRADE_TOHO_BALL, $00
...
; SPRITE_ANIM_INDEX_MAGNET_TRAIN
	db SPRITE_ANIM_FRAMESET_MAGNET_TRAIN, SPRITE_ANIM_SEQ_NULL, $00
...
; SPRITE_ANIM_INDEX_INTRO_NAZRIN
	db SPRITE_ANIM_FRAMESET_INTRO_NAZRIN, SPRITE_ANIM_SEQ_INTRO_NAZRIN, $00
; SPRITE_ANIM_INDEX_INTRO_TTEI
	db SPRITE_ANIM_FRAMESET_INTRO_TTEI, SPRITE_ANIM_SEQ_TTEI_CSHIZUHA, $00
; SPRITE_ANIM_INDEX_INTRO_CSHIZUHA
	db SPRITE_ANIM_FRAMESET_INTRO_CSHIZUHA, SPRITE_ANIM_SEQ_TTEI_CSHIZUHA, $00
; SPRITE_ANIM_INDEX_INTRO_CNUE
	db SPRITE_ANIM_FRAMESET_INTRO_CNUE_1, SPRITE_ANIM_SEQ_CNUE, $00
; SPRITE_ANIM_INDEX_INTRO_CNUE_F
	db SPRITE_ANIM_FRAMESET_INTRO_CNUE_F, SPRITE_ANIM_SEQ_CNUE_F, $00
; SPRITE_ANIM_INDEX_INTRO_NAZRIN_AWAY
	db SPRITE_ANIM_FRAMESET_INTRO_NAZRIN_AWAY, SPRITE_ANIM_SEQ_NAZRIN_AWAY, $00
; SPRITE_ANIM_INDEX_ICHIRIN
	db SPRITE_ANIM_FRAMESET_ICHIRIN_LEFT, SPRITE_ANIM_SEQ_NULL, $00
...
; SPRITE_ANIM_INDEX_DEX_CNUE_CURSOR
	db SPRITE_ANIM_FRAMESET_DEX_CNUE_CURSOR, SPRITE_ANIM_SEQ_DEX_CURSOR, $00
; SPRITE_ANIM_INDEX_DEX_DLUIZE
	db SPRITE_ANIM_FRAMESET_DEX_DLUIZE, SPRITE_ANIM_SEQ_NULL, $00
; SPRITE_ANIM_INDEX_TOWN_MAP_FLY
	db SPRITE_ANIM_FRAMESET_TOWN_MAP_FLY, SPRITE_ANIM_SEQ_TOWN_MAP_FLY, $00
; SPRITE_ANIM_INDEX_GREEN_WALK
	db SPRITE_ANIM_FRAMESET_GREEN_WALK, SPRITE_ANIM_SEQ_NULL, $00
; SPRITE_ANIM_INDEX_FLY_MON
	db SPRITE_ANIM_FRAMESET_FLY_MON, SPRITE_ANIM_SEQ_NULL, $00
