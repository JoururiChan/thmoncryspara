...
; SPRITE_ANIM_INDEX_INTRO_NAZRIN
	db SPRITE_ANIM_FRAMESET_INTRO_KASEN, SPRITE_ANIM_SEQ_INTRO_KASEN, $00
...
; SPRITE_ANIM_INDEX_INTRO_KASEN_AWAY
	db SPRITE_ANIM_FRAMESET_INTRO_KASEN_AWAY, SPRITE_ANIM_SEQ_KASEN_AWAY, $00
