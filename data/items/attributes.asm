...
; CHERISH BALL
	item_attribute 1000, 0, 0, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; POTION
	item_attribute 200, 0, 20, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; SUPER POTION
	item_attribute 700, 0, 60, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; HYPER POTION
	item_attribute 1500, 0, 120, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; MAX POTION
	item_attribute 2500, 0, -1, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; ANTIDOTE
	item_attribute 200, 0, 1 << PSN, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; BURN HEAL
	item_attribute 300, 0, 1 << BRN, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; PARALYZE HEAL
	item_attribute 300, 0, 1 << PAR, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; AWAKENING
	item_attribute 100, 0, SLP_MASK, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; ICE HEAL
	item_attribute 100, 0, 1 << FRZ, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; FULL HEAL
	item_attribute 400, 0, -1, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; FULL RESTORE
	item_attribute 3000, 0, -1, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; REVIVE
	item_attribute 2000, 0, 0, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; MAX REVIVE
	item_attribute 4000, 0, 0, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; ETHER
	item_attribute 1200, 0, 10, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; MAX ETHER
	item_attribute 2000, 0, -1, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; ELIXIR
	item_attribute 3000, 0, 10, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; MAX ELIXIR
	item_attribute 4500, 0, -1, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; HP UP
	item_attribute 10000, 0, MON_HP_EV - MON_EVS, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_NOUSE
; PROTEIN
	item_attribute 10000, 0, MON_ATK_EV - MON_EVS, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_NOUSE
; IRON
	item_attribute 10000, 0, MON_DEF_EV - MON_EVS, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_NOUSE
; CARBOS
	item_attribute 10000, 0, MON_SPE_EV - MON_EVS, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_NOUSE
; CALCIUM
	item_attribute 10000, 0, MON_SAT_EV - MON_EVS, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ZINC
	item_attribute 10000, 0, MON_SDF_EV - MON_EVS, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_NOUSE
; RARE CANDY
	item_attribute 10000, 0, 0, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_NOUSE
; PP UP
	item_attribute 10000, 0, 0, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_NOUSE
; PP MAX
	item_attribute 10000, 0, 0, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_NOUSE
; FRESH WATER
	item_attribute 200, 0, 30, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; SODA POP
	item_attribute 300, 0, 50, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; LEMONADE
	item_attribute 350, 0, 70, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; MOOMOO MILK
	item_attribute 500, 0, 100, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; RAGECANDYBAR
	item_attribute 300, 0, -1, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; PEWTERCRUNCH
	item_attribute 300, 0, -1, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; ENERGYPOWDER
	item_attribute 500, 0, 60, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; ENERGY ROOT
	item_attribute 1200, 0, 120, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; HEAL POWDER
	item_attribute 300, 0, -1, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; REVIVAL HERB
	item_attribute 2800, 0, 0, MEDICINE_B, ITEMMENU_PARTY, ITEMMENU_PARTY
; SACRED ASH
	item_attribute 50000, 0, 0, MEDICINE_B, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; CHERI BERRY
...
; FIGY BERRY
	item_attribute 10, HELD_BERRY, 0, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; POMEG BERRY
	item_attribute 10, HELD_NO_BULLET_SEED, MON_HP_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; KELPSY BERRY
	item_attribute 10, HELD_NO_BULLET_SEED, MON_ATK_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; QUALOT BERRY
	item_attribute 10, HELD_NO_BULLET_SEED, MON_DEF_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; HONDEW BERRY
	item_attribute 10, HELD_NO_BULLET_SEED, MON_SAT_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; GREPA BERRY
	item_attribute 10, HELD_NO_BULLET_SEED, MON_SDF_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TAMATO BERRY
	item_attribute 10, HELD_NO_BULLET_SEED, MON_SPE_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; LIECHI BERRY
...
; EXP.SHARE
	item_attribute 3000, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SILK SCARF
	item_attribute 1000, HELD_TYPE_BOOST, ILLUSION, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLACK BELT
	item_attribute 1000, HELD_TYPE_BOOST, DREAM, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SHARP BEAK
	item_attribute 1000, HELD_TYPE_BOOST, FLYING, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; POISON BARB
	item_attribute 1000, HELD_TYPE_BOOST, MIASMA, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SOFT SAND
	item_attribute 1000, HELD_TYPE_BOOST, EARTH, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; HARD STONE
	item_attribute 1000, HELD_TYPE_BOOST, BEAST, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SILVERPOWDER
...
; MIRACLE SEED
	item_attribute 1000, HELD_TYPE_BOOST, NATURE, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MAGNET
	item_attribute 1000, HELD_TYPE_BOOST, WIND, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; TWISTEDSPOON
	item_attribute 1000, HELD_TYPE_BOOST, REASON, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; NEVERMELTICE
	item_attribute 1000, HELD_TYPE_BOOST, ICE, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; DRAGON FANG
	item_attribute 1000, HELD_TYPE_BOOST, FAITH, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLACKGLASSES
	item_attribute 1000, HELD_TYPE_BOOST, DARK, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PINK BOW
	item_attribute 1000, HELD_TYPE_BOOST, HEART, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BERSERK GENE
