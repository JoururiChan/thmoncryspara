...
SakuyaEvosAttacks:
	...
	db 44, ICE_PUNCH ; Synthesis → similar move
	db 47, ICE_BEAM
...
CMeiraEvosAttacks:
	...
	db 5, FORESIGHT
	db 9, BLADE_FLASH
	db 14, METAL_CLAW; Follow Me → new move
...
CSunnyEvosAttacks:
	evo_data EVOLVE_LEVEL, 21, SUNNY
	evo_data EVOLVE_ITEM, SUN_STONE, ASUNNY
	db -1 ; no more evolutions
	db 1, EMBER
	db 1, GROWL
	db 6, FOCUS_ENERGY
...
CStarEvosAttacks:
	evo_data EVOLVE_LEVEL, 21, STAR
	evo_data EVOLVE_ITEM, SHINY_STONE, DSTAR
	db -1 ; no more evolutions
	db 1, WATER_GUN
	db 1, GROWL
	db 6, DEFENSE_CURL
...
CLunaEvosAttacks:
	evo_data EVOLVE_LEVEL, 21, LUNA
	evo_data EVOLVE_ITEM, MOON_STONE, TLUNA
	db -1 ; no more evolutions
	db 1, THUNDERSHOCK
	db 1, LEER
	db 6, DISABLE
...
CKyoukoEvosAttacks:
	evo_data EVOLVE_LEVEL, 25, KYOUKO
	db -1 ; no more evolutions
	db 1, TACKLE
	db 1, GROWL
	db 6, PROTECT
...
CYoshikaEvosAttacks:
	evo_data EVOLVE_LEVEL, 30, YOSHIKA
	db -1 ; no more evolutions
	db 1, LICK
	db 1, PROTECT
	db 5, DEFENSE_CURL
...
CMamizouEvosAttacks:
	evo_data EVOLVE_LEVEL, 38, MAMIZOU
	db -1 ; no more evolutions
	db 1, VINE_WHIP
	db 1, PROTECT
	db 6, CONVERSION
...
CKokoroEvosAttacks:
	evo_data EVOLVE_LEVEL, 40, KOKORO
	db -1 ; no more evolutions
	db 1, LICK
	db 1, SING
	db 6, DISARM_VOICE
