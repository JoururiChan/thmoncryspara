InitialEvents:
	...
	dw EVENT_MAHOGANY_MART_LANCE_AND_CSUIKA
	dw EVENT_TEAM_ROCKET_BASE_B2F_PETREL
	dw EVENT_TEAM_ROCKET_BASE_B2F_ARIANA
	dw EVENT_TEAM_ROCKET_BASE_B2F_CSUIKA
	...
	dw EVENT_AZALEA_TOWN_WAKASAGIS
	dw EVENT_KURTS_HOUSE_WAKASAGI
	dw EVENT_GUIDE_GENT_VISIBLE_IN_CHERRYGROVE
	dw EVENT_ELMS_AIDE_IN_VIOLET_TOHOMON_CENTER
	...
	dw EVENT_TIN_TOWER_ROOF_CICHIRIN
	dw EVENT_WHIRL_ISLAND_TKOGASA_CHAMBER_TKOGASA
	...
	dw EVENT_SAW_NAZRIN_ON_ROUTE_36
	dw EVENT_SAW_NAZRIN_ON_ROUTE_42
	dw EVENT_SAW_NAZRIN_AT_CIANWOOD_CITY
	dw EVENT_YELLOW_FOREST_ROCKET_TAKEOVER
	dw EVENT_ROUTE_48_JESSIE
	dw EVENT_ROUTE_48_JAMES
	dw EVENT_ROUTE_48_NURSE
	dw EVENT_YELLOW_FOREST_PARSEE
	...
	dw EVENT_MT_MOON_SQUARE_CMEIRA
	...
	dw EVENT_ROUTE_8_KANTO_TOHOMON_FEDERATION
	...
	dw EVENT_LAWRENCES_TRAN_ROUTE_10
	...
	dw EVENT_INDIGO_PLATEAU_TOHOCENTER_RIVAL
	dw EVENT_INDIGO_PLATEAU_TOHOCENTER_LYRA
	dw EVENT_INDIGO_PLATEAU_TOHOCENTER_YELLOW
	dw EVENT_MYSTRI_CNUE_W
	dw EVENT_MYSTRI_CNUE_A
	dw EVENT_MYSTRI_CNUE_R
	dw EVENT_MYSTRI_CNUE_P
