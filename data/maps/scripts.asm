...
INCLUDE "maps/RuinsOfAlphAYuyukoChamber.asm"
...
INCLUDE "maps/RuinsOfAlphAYuyukoItemRoom.asm"
...
INCLUDE "maps/RuinsOfAlphAYuyukoWordRoom.asm"
...
INCLUDE "maps/SaffronhrinKidHouse.asm"
